...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      "fixed inset-0 z-50 bg-background/80 backdrop-blur-sm data-[state=open]:animate-[dialog-fade-in_300ms_ease-in-out] data-[state=closed]:animate-[dialog-fade-out_250ms_ease-in-out]",
      className
    )}
    {...props}
  />
